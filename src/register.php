...
use Kode\Messaging\Adapter\Mqtt\MqttOverWsClient;
use Kode\Messaging\Adapter\Mqtt\MqttOverWsServer;
...
MqttOverWsClient::autoRegister();
MqttOverWsServer::autoRegister();
MqttServer::autoRegister();
